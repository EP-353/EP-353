...
//Compile with:
//clang 02.Chorus.c -o 02.Chorus -lsndfile
//Run with:
//./02.Chorus

#define kInputFileName "GuitarArpeggiate.wav"
#define kOutputFileName "Chorus.wav"
#define kDepth 0.01 // second
#define kOffset 0.025 // second (Needs to be bigger than or equal to kDepth to avoid negative numbers)
#define kRate 0.1 // Hz
